...
```bash
sharek integrations:settings youtube-def456
```
...
```bash
sharek integrations:settings twitter-ghi789
```
...
```bash
sharek integrations:settings linkedin-jkl012
```
...
```bash
sharek integrations:settings tiktok-mno345
```
...
```bash
sharek integrations:settings instagram-pqr678
```
...
```bash
sharek integrations:settings threads-stu901
```
...
sharek integrations:settings reddit-456
```
...
```bash
sharek integrations:settings twitter-789 | jq '.output.maxLength'
# Output: 280
```
...
sharek integrations:settings reddit-123 | jq '.output.settings'

# Extract specific field properties
sharek integrations:settings reddit-123 \
...
SETTINGS=$(sharek integrations:settings reddit-123)
...
```bash
sharek integrations:settings invalid-id
