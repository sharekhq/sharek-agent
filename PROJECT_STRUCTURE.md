# Sharek CLI - Project Structure

## Overview

The Sharek CLI is a complete command-line interface package for interacting with the Sharek social media scheduling API. It's designed for developers and AI agents to automate social media posting.
...
│   ├── api.ts                    # API client for Sharek API
...
#### `src/api.ts`
- API client class `SharekAPI`
- Handles all HTTP requests to the Sharek API
- Methods for:
  - Creating posts
  - Listing posts
  - Deleting posts
...
- `uploadFile()` - Upload images to Sharek
...
- Package name: `sharek`
- Version: `1.0.0`
- Executable bin: `sharek` → `dist/index.js`
...
|----------|----------|---------|-------|
| `SHAREK_API_KEY` | ✅ Yes | - | Authentication token |
...
SHAREK_API_KEY=test node dist/index.js integrations:list
```
...
- **Issues:** https://github.com/sharekhq/sharek-app/issues
- **Docs:** See README.md, SKILL.md, QUICK_START.md
- **Website:** https://dash.sharek.app
